                ...
                <TabContentContainer>
                    <TabContent id='poi' className='selectedTab'>
                        ...
                        <div id='upload_complete' className='center-text gr-padding-20 invisible'>
                            ...
                            <p id='text_poi_pending' className='invisible'>{it.L('Your document is being reviewed, please check back in 1-3 days.')}</p>
                            <p id='text_poa_required' className='invisible'>{it.L('Your document is being reviewed, please check back in 1-3 days. You must also submit a proof of address.')}</p>
                            <Button
                                id='button_poa_required'
                        ...
                        <div id='authentication'>
                            <div id='authentication-message'>
                                ...
                                <div id='pending_poa' className='center-text gr-gutter gr-padding-20 invisible'>
                                    ...
                                    <p id='poa_pending' className='invisible'>{it.L('Your document is being reviewed, please check back in 1-3 days.')}</p>
                                    <p id='text_poi_required' className='invisible'>{it.L('Your document is being reviewed, please check back in 1-3 days. You must also submit a proof of identity.')}</p>
                                    <Button
                                        id='button_poi_required'
                                        className='button invisible'
