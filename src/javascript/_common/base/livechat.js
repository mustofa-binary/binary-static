...
const LiveChat = (() => {
    const init = () => {
        if (window.LiveChatWidget) {
            ...
            const blank_session_variables = { loginid: '', landing_company_shortcode: '', currency: '', residence: '' };
            window.LiveChatWidget.call('set_customer_email', ' ');
            window.LiveChatWidget.call('set_customer_name', ' ');
            window.LiveChatWidget.call('set_session_variables', blank_session_variables);
            ...
            window.LiveChatWidget.on('visibility_changed', ({ visibility }) => {
                ...
                if (visibility === 'maximized' && ClientBase.isLoggedIn()) {
                    ...
                    const current_session_variables = {
                        ...loginid && { loginid },
                    ...
                    window.LiveChatWidget.call('set_session_variables', current_session_variables);
                }
